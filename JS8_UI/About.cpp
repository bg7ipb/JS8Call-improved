...
CAboutDlg::CAboutDlg(QWidget *parent) : QDialog(parent), ui(new Ui::CAboutDlg) {
    ...
    ui->labelTxt->setText(QString(
        ...
        "<h3>JS8CALL-CN " JS8CALL_VERSION " 版本说明</h3>"
        ...
        "<p align='left'><strong>【中文词库（ILC 码本）】</strong><br/>"
        "- 本版内置中文词库，并在启动时自动检查词库更新（含 SHA-256 校验）；有新版时会弹窗提示下载。<br/>"
        "- 词库更新后请及时应用；未应用前，可能无法正确还原新增词条。<br/>"
        "- 收发双方需使用相同版本的词库；任一方未更新，对方的中文都将无法正确还原。</p>"
        ...
        "- 本版为非官方改版，未经 JS8Call 官方团队（JS8Call-Improved）认可或背书；作为面向中文 HAM 社区的中文本地化版本独立发布<br/>"
